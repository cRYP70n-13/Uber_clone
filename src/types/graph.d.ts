...
export interface Mutation {
  EmailSingIn: EmailSignInResponse;
  EmailSignUp: EmailSingUpResponse;
  FacebookConnect: FacebookConnectResponse;
}

export interface EmailSingInMutationArgs {
  email: string;
  password: string;
}
